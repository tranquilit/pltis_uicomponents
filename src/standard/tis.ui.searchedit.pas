...
type
  ...
  private
    ...
    fAutoCompleteOnlyPrefix: Boolean;
    fSelStart: Integer;
  ...
  published
    ...
    property AutoCompleteOnlyPrefix: Boolean read fAutoCompleteOnlyPrefix write fAutoCompleteOnlyPrefix default True;
    // ------------------------------- new events -----------------------------------
...
var
  aItem: String;
begin
  if AutoCompleteOnlyPrefix then
    Exit;
...
begin
  ...
  begin
    ...
    begin
      if not OnIsMatchingText(Items[Idx], sPrefixText, CaseSensitive, AutoCompleteOnlyPrefix) then
        continue;
    end
    else if not IsMatchingUserText(Items[Idx], sPrefixText, AutoCompleteOnlyPrefix) then
      continue;
...
begin
  ...
  begin
    ...
    begin
      ...
      if not AutoCompleteOnlyPrefix and (sPrefixText <> sCompleteText) then
      ...
      begin
        ...
        and AutoCompleteOnlyPrefix then
